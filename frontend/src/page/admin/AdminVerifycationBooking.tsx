                ...
                <div className="modal-body">
                  {
                    viewDataById && (
                      <ul style={{ listStyle: "none" }}>
                        ...
                        <li className="d-flex">
                          <div style={{ width: "40%" }}>No. Identita</div>
                          <div>:</div>
                        ...
                        <li className="d-flex">
                          <div style={{ width: "40%" }}>Kebangsaan</div>
                          <div>:</div>
                          <div className="ms-2" style={{ fontWeight: "bold" }}>{viewDataById.kebangsaan_ketua}</div>
                        </li>
                        <li className="d-flex">
                        ...
                        </li>
                        {
                          viewDataById.anggota.map((value: any, index: any) => (
                            <ul key={index}>
                              ...
                              <li className="d-flex">
                                <div style={{ marginLeft: "19px", width: "30%" }}>No. Telepone</div>
                                <div>:</div>
                              ...
                              <li className="d-flex">
                                <div style={{ marginLeft: "19px", width: "30%" }}>Kebangsaan</div>
                                <div>:</div>
                                <div className="ms-2" style={{ fontWeight: "bold" }}>{value.kebangsaan}</div>
                              </li>
                            </ul>
                          ))
                        }
